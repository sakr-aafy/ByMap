...
router.get('/notifications',      ctrl.getNotifications); // GET  /api/admin/notifications
...
router.put('/users/:id/add-points', ctrl.addPoints);       // PUT  /api/admin/users/:id/add-points
